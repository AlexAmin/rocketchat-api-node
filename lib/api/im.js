...
class IM {
    ...
    create(username, usernames, callback) {
        return this.client.request("POST", "im.create", {username, usernames}, callback);
    }
    ...
    members(roomId, callback) {
        return this.client.request("GET", `im.members?$roomId=${roomId}`, null, callback);
    }
