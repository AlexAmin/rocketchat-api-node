...
class RestClient extends Client {
    ...
    constructor(protocol, host, port, basePath, verbose) {
        super(protocol, host, port, basePath);
    ...
    request(method, path, params, callback = null) {
        ...
        return new Promise((resolve, reject) => {
            this.clientRequest(options, (error, response, body) => {
                ...
                if(this.verbose){
                    console.error("Rocket.Chat - Body",body);
                }
                let errorMessage = {
                ...
                if (response.statusCode !== 200) {
                    ...
                    let errContent = new RequestError(errorMessage[response.statusCode] || errorMessage["else"], response.statusCode, body ? body.errorType : null);
