...
function RocketChatClient(protocol, host, port, username, password, onConnected, verbose) {
    let _authToken;
    let _userId;
    let basepath = "";
    ...
    const restClient = new net.RestClient(protocol, host, port, basepath + "/api/v1/", verbose);
